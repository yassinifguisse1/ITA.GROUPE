...
export default function HomePageClient() {
  ...
  return (
    <div className="relative" key={language}>
      <main>
        <Suspense fallback={<div className="hero-section"><div className="hero-title">
            {/* iTA Groupe Logo*/}
            <Image src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/document-uploads/Untitled-design-29-1759847984982.png" alt="iTA Groupe Logo" width={100} height={100} />
